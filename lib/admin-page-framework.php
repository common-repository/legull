<?php 
/**
	Admin Page Framework - Minified Version v3.5.2 by Michael Uno 
...
class Legull_AdminPageFramework_Widget_Factory extends WP_Widget {
    ...
    public function form($aFormData) {
        ...
        $this->oCaller->oForm = new Legull_AdminPageFramework_FormElement($this->oCaller->oProp->sFieldsType, $this->oCaller->oProp->sCapability, $this->oCaller);
    }
