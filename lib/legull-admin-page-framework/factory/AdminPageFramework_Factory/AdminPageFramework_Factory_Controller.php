...
abstract class Legull_AdminPageFramework_Factory_Controller extends Legull_AdminPageFramework_Factory_View {
    ...
    public function setFieldErrors($aErrors) {
        $GLOBALS['aLegull_AdminPageFramework']['aFieldErrors'] = $this->oUtil->getElement($GLOBALS, array('aLegull_AdminPageFramework', 'aFieldErrors'), array());
    ...
    public function setSettingNotice($sMessage, $sType = 'error', $asAttributes = array(), $bOverride = true) {
        $GLOBALS['aLegull_AdminPageFramework']['aNotices'] = $this->oUtil->getElement($GLOBALS, array('aLegull_AdminPageFramework', 'aNotices'), array());
    ...
    public function hasSettingNotice($sType = '') {
        $_aNotices = $this->oUtil->getElementAsArray($GLOBALS, array('aLegull_AdminPageFramework', 'aNotices'), array());
        if (!$sType) {
