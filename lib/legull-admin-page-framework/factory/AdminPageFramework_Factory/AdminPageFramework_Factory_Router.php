...
abstract class Legull_AdminPageFramework_Factory_Router {
    ...
    protected $_aFormElementClassNameMap = array('page' => 'Legull_AdminPageFramework_FormElement_Page', 'network_admin_page' => 'Legull_AdminPageFramework_FormElement_Page', 'post_meta_box' => 'Legull_AdminPageFramework_FormElement_Meta', 'page_meta_box' => 'Legull_AdminPageFramework_FormElement', 'post_type' => 'Legull_AdminPageFramework_FormElement', 'taxonomy' => 'Legull_AdminPageFramework_FormElement', 'widget' => 'Legull_AdminPageFramework_FormElement', 'user_meta' => 'Legull_AdminPageFramework_FormElement_Meta',);
    ...
    protected $_aResourceClassNameMap = array('page' => 'Legull_AdminPageFramework_Resource_Page', 'network_admin_page' => 'Legull_AdminPageFramework_Resource_Page', 'post_meta_box' => 'Legull_AdminPageFramework_Resource_MetaBox', 'page_meta_box' => 'Legull_AdminPageFramework_Resource_MetaBox_Page', 'post_type' => 'Legull_AdminPageFramework_Resource_PostType', 'taxonomy' => 'Legull_AdminPageFramework_Resource_TaxonomyField', 'widget' => 'Legull_AdminPageFramework_Resource_Widget', 'user_meta' => 'Legull_AdminPageFramework_Resource_UserMeta',);
    ...
    protected $_aHelpPaneClassNameMap = array('page' => 'Legull_AdminPageFramework_HelpPane_Page', 'network_admin_page' => 'Legull_AdminPageFramework_HelpPane_Page', 'post_meta_box' => 'Legull_AdminPageFramework_HelpPane_MetaBox', 'page_meta_box' => 'Legull_AdminPageFramework_HelpPane_MetaBox_Page', 'post_type' => null, 'taxonomy' => 'Legull_AdminPageFramework_HelpPane_TaxonomyField', 'widget' => 'Legull_AdminPageFramework_HelpPane_Widget', 'user_meta' => 'Legull_AdminPageFramework_HelpPane_UserMeta',);
    ...
    protected $_aLinkClassNameMap = array('page' => 'Legull_AdminPageFramework_Link_Page', 'network_admin_page' => 'Legull_AdminPageFramework_Link_NetworkAdmin', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'Legull_AdminPageFramework_Link_PostType', 'taxonomy' => null, 'widget' => null, 'user_meta' => null,);
    ...
    protected $_aPageLoadClassNameMap = array('page' => 'Legull_AdminPageFramework_PageLoadInfo_Page', 'network_admin_page' => 'Legull_AdminPageFramework_PageLoadInfo_NetworkAdminPage', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'Legull_AdminPageFramework_PageLoadInfo_PostType', 'taxonomy' => null, 'widget' => null, 'user_meta' => null,);
