 ...
 */
abstract class Legull_AdminPageFramework_Form_Model_Export extends Legull_AdminPageFramework_Form_Model_Import {
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new Legull_AdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
