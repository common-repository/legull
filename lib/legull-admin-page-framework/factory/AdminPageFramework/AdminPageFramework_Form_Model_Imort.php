 ...
 */
abstract class Legull_AdminPageFramework_Form_Model_Import extends Legull_AdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new Legull_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
