...
/**
 ...
 Included Components: Admin Pages, Network Admin Pages, Custom Post Types, Page Meta Boxes
 Generated on 2015-04-04 */
...
final class Legull_AdminPageFramework_Registry extends Legull_AdminPageFramework_Registry_Base {
    ...
    static public function setUp($sFilePath = __FILE__) {
        ...
        self::$sAutoLoaderPath = isset(self::$aClassFiles['Legull_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['Legull_AdminPageFramework_RegisterClasses'] : '';
...
final class Legull_AdminPageFramework_Bootstrap {
    public function __construct($sLibraryPath = __FILE__) {
        ...
        new Legull_AdminPageFramework_RegisterClasses(empty(Legull_AdminPageFramework_Registry::$aClassFiles) ? Legull_AdminPageFramework_Registry::$sDirPath : '', array('exclude_class_names' => array('Legull_AdminPageFramework_MinifiedVersionHeader', 'Legull_AdminPageFramework_BeautifiedVersionHeader',),), Legull_AdminPageFramework_Registry::$aClassFiles);
        Legull_AdminPageFramework_Registry::$bIsDevelopmentVersion = class_exists('Legull_AdminPageFramework_InclusionClassFilesHeader');
    }
