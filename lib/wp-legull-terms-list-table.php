...
class WP_Legull_Terms_List_Table extends WP_List_Table {
	...
	public function __construct( $args = array() ) {
		...
		$legull_terms_args = array( 'post_type' => LEGULL_CPT );
		$legull_terms = new WP_Query( $legull_terms_args );
		$this->items = $legull_terms->posts;
	...
	public function get_columns() {
		...
		$posts_columns['date'] = __( 'Published', 'legull' );
	...
	public function inline_edit() {
		...
		$core_columns = array( 'cb' => false, 'date' => true, 'title' => true, 'categories' => false, 'tags' => false, 'comments' => false, 'author' => false );
